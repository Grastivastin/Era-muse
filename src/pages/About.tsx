...
export default function About() {
  return (
    <Layout>
      <section className="container py-24 max-w-2xl space-y-8 text-center bg-paper/70 backdrop-blur-sm rounded-3xl my-12 px-8 shadow-petal">
        <p className="font-script text-3xl text-rose-dust">our manifesto</p>
        <h1 className="font-display text-6xl text-ink font-bold">A love letter to getting dressed.</h1>
        <div className="font-serif text-xl text-ink italic space-y-4 text-left pt-6">
        ...
        <p className="font-script text-3xl text-rose-dust pt-8">— Sash &amp; Co</p>
      </section>
    </Layout>
  );
}